...
var Annotation = function (_Record) {
  ...
  createClass(Annotation, [{
    ...
    value: function create() {
      ...
      if (Range$1.isRange(attrs)) {
        return Annotation.fromJSON(Range$1.createProperties(attrs));
      }
...
var Text = function (_Record) {
  ...
  createClass(Text, [{
    ...
    value: function fromJSON(object) {
      ...
      invariant$1(object.leaves == null, 'As of slate@0.46, the `leaves` property of text nodes has been removed! Each individual leaf should be created as a text node instead.');
...
mixin$1(ModelInterface, [Annotation, Block, Decoration, Document, Inline, Leaf$1, Mark, Node, Operation, Point, Range$1, Selection, Text, Value]);
...
var ElementInterface = function () {
  ...
  createClass(ElementInterface, [{
    ...
    value: function createIterable() {
      ...
      return defineProperty$1({}, Symbol.iterator, function () {
    ...
    value: function filterDescendants() {
      var predicate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : identity$1;
    ...
    value: function getFurthest(path) {
      var predicate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : identity$1;
...
mixin$1(RangeInterface, [Annotation, Decoration, Range$1, Selection]);
...
var createRenderAnnotation = (function (_ref) {
  ...
  var renderAnnotation = function renderAnnotation(props, editor, next) {
    ...
    switch (type) {
      case ANNOTATION_TYPES.cursor:
        return React.createElement(Box, _extends$1({
          as: "span"
        }, attributes, {
          style: {
...
var createEditor = (function (_ref) {
  var React = _ref.React,
      Box = _ref.Box;
  ...
  var RichTextEditor = React.forwardRef(function (props, ref) {
    return React.createElement(Editor, _extends$1$1({
      ref: ref
    }, props, {
      renderAnnotation: renderAnnotation
    }));
